...
Accessibility means eliminating barriers on the web so that everyone can use them. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

 Transcripts for Audio, Keyboard Input and Alternative Text for Images.


3. How would you explain the concept of a variable to someone new to programming?

Variable means anything that can vary and can be changed at any time. JavaScript uses the reserved keyword var to declare a variable. A variable must have a unique name.
